			...
			<div class="tab-content">
				<div class="row mb-3">
					...
					<div class="col-sm-5">
						...
						?>
						<small>Perbolehkan pegawai register akun baru?</small>
					</div>
				</div>
				<?php
				...
				<div class="detail-container"<?=$display?>>
					<div class="row mb-3">
						...
						<div class="col-sm-5">
							...
							?>
							<small>Langsung: setelah register, pegawai langsung aktif dan bisa login. Manual: setelah register, Admin mengaktivasi akun melalui menu edit pegawai. Email Konfirmasi: setelah register, link aktivasi akan dikirim via email.</small>
						</div>
					</div>
					<div class="row mb-3">
						...
						<div class="col-sm-5">
							...
							?>
							<small>Role untuk pegawai baru yang melakukan registrasi.</small>
						</div>
					</div>
					<div class="row mb-3">
