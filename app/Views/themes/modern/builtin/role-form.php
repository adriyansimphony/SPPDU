			...
			<div>
				...
				<div class="row mb-3">
					...
					<div class="col-sm-8">
						...
						echo options(['name' => 'id_module', 'class' => 'select2'], $options, set_value('id_module', @$role['id_module']));
						?>
						<p class="mt-0"><em>Halaman awal sesaat setelah pegawai login. Pastikan role memiliki permission pada halaman yang dipilih</p>
					</div>
				</div>
				<div class="row mb-3">
					<?php 
