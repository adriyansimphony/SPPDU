			...
			<div class="tab-content" id="myTabContent">
				<div class="row mb-3">
					...
					<div class="col-sm-5">
						...
						<div class="mt-1">Contoh file: <a title="Contoh Data Pegawai" href="<?=$config->baseURL?>public/files/Format Data Pegawai.xlsx">Data Pegawai.xlsx</a></div>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-5">
