				...
				<div class="row mb-3">
					...
					<div class="col-sm-5">
						<input type="file" class="file form-control" name="file_excel">
							<small class="small" style="display:block">Ekstensi file harus .xlsx. Baris pertama file excel harus disertakan dan tidak boleh dirubah, karena akan diidentifikasi sebagai nama kolom tabel database. Gunakan format file excel berikut: <a href="<?=base_url() . '/pendapatan/formatUploadFileExcel" title="Format File Excel">Format Data Pendapatan.xlsx</a>'?> </small>
