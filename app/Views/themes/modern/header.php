		...
		<div class="pull-right nav-header nav-header-right">
			<ul class="d-flex align-items-center">
				...
				<li class="ps-2 nav-account">
					<?php 
					$img_url = !empty($pegawai['avatar']) && file_exists(ROOTPATH . '/public/images/pegawai/' . $pegawai['avatar']) ? $config->baseURL . '/public/images/pegawai/' . $pegawai['avatar'] : $config->baseURL . '/public/images/pegawai/default.png';
					$account_link = $config->baseURL . 'pegawai';
					?>
					<a class="profile-btn" href="<?=$account_link?>" data-bs-toggle="dropdown"><img src="<?=$img_url?>" alt="pegawai_img"></a>
						<?php
						if ($isloggedin) { 
							?>
							<ul class="dropdown-menu">
								<li class="dropdown-profile px-4 pt-4 pb-2">
									<div class="avatar">
										<a href="<?=$config->baseURL . 'builtin/pegawai/edit?id=' . $pegawai['id_pegawai'];?>">
											<img src="<?=$img_url?>" alt="pegawai_img">
										</a>
									</div>
									<div class="card-content mt-3">
									<p><?=strtoupper($pegawai['nama'])?></p>
									<p><small>Email: <?=$pegawai['email']?></small></p>
									</div>
								</li>
								<li>
									<a class="dropdown-item py-2" href="<?=$config->baseURL?>builtin/pegawai/edit-password">Change Password</a>
								</li>
								<li>
