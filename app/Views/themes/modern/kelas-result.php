<div class="card">
	...
	<div class="card-body">
		<div class="text-center text-sm-start">
			...
			<button class="btn btn-danger btn-delete-all-kelas btn-xs" <?=$jml_kelas ? '' : 'disabled'?>><i class="fas fa-trash me-2"></i>Hapus Semua Kelas</button>
		</div>
		<hr/>
		<?php 
		if (!empty($msg)) {
		...
		<span id="dataTables-url" style="display:none"><?=base_url() . '/kelas/getDataDT'?></span>
	</div>
</div>