<div class="card">
	...
	<div class="card-body">
		<div class="text-center text-sm-start">
			...
			<button class="btn btn-danger btn-delete-all-data btn-xs" <?=$jml_jenis_pendapatan ? '' : 'disabled'?>><i class="fas fa-trash me-2"></i>Hapus Semua Data</button>
		</div>
		<hr/>
		<?php 
		if (!empty($msg)) {
		...
		$column =[
					'ignore_urut' => 'No'
					, 'nama_pendapatan_jenis' => 'Nama Pendapatan'
					, 'kategori' => 'Kategori'
					, 'jenis_periode' => 'Periode'
					, 'nama_pendapatan_sumber' => 'Sumber'
					, 'perlu_tagihan_siswa' => 'Tagihan Siswa'
		...
		<span id="dataTables-url" style="display:none"><?=base_url() . '/pendapatan-jenis/getDataDT'?></span>
	</div>
</div>