...
?>
<div class="list-pembayaran-terpilih p-4 py-4"><span class="belum-ada">Pendapatan belum dipilih</span></div>
<div class="p-4 pt-0">
...
<span id="jwdmodal-dataTables-url" style="display:none"><?=base_url() . '/pendapatan-lain/getDataDTJenisPembayaran'?></span>