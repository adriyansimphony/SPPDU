...
<div class="card-body">
	...
	<form action="<?=current_url()?>" method="post" accept-charset="utf-8">
		...
		<div class="mb-3">
			<label class="mb-2">NIP Pegawai</label>
			<input type="text"  name="nip_pegawai" value="<?=set_value('nip_pegawai', '')?>" class="form-control register-input" placeholder="NIP Pegawai" aria-label="NIP Pegawai" required>
			<p class="small">NIP Pegawai untuk login</p>
		</div>
		<div class="mb-3">
