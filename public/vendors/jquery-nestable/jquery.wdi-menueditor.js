...
;(function($)
{
	$.extend($.fn.np.prototype, 
	{
		customInit : function() 
		{
			...
			$(this.el).undelegate( 'button', 'click').delegate('button', 'click', function(e) {
		...
		addOptions: function() {
			var addOptions = {
				...
				editBtnHTML 	: '<button data-action="edit" type="button" class="text-success far fa-pen pull-right"></button>',
