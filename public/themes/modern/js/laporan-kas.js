...
jQuery(document).ready(function () {
	...
	$('.btn-excel').click(function() {
		...
		filename = 'Laporan Kas - ' + params.get('daterange') + '.xlsx';
		url = base_url + 'laporan-kas/ajaxExportExcel?' + query_string;
		fetch(url)
		  .then(resp => resp.blob())
		  .then(blob => {
	...
	$('.btn-pdf').click(function() {
		...
		filename = 'Laporan Kas - ' + params.get('daterange') + '.pdf';
		url = base_url + 'laporan-kas/ajaxExportPdf?' + query_string;
		fetch(url)
		  .then(resp => resp.blob())
		  .then(blob => {
				$this.prop('disabled', false);
